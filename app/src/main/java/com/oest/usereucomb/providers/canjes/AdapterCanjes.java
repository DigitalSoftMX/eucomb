...
import java.util.ArrayList;
    ...
    public class AdapterCanjes extends RecyclerView.Adapter<AdapterCanjes.ViewHolder>{
        ...
        private ArrayList<SectionCanjes> sectionss;

        public AdapterCanjes(ArrayList<SectionCanjes> sectionss){
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            SectionCanjes section=sectionss.get(position);
            holder.bind(section);
        }
        ...
        public static class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public void bind(final SectionCanjes section){
                ...
                String ima = section.getLugar();
                Log.e("imagenjjjddd", ima);
