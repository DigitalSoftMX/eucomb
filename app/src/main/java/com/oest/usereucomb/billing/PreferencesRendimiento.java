...
public class PreferencesRendimiento {

    public static final String STRING_PREFERENCES_REND = "com.itm.oest.rendimiento";
    public static final String PREFERENCE_ESTADO_BUTTON_SESION_REND = "estado.button.sesion";
    public static final String PREFERENCE_REND = "usuario.rendiminetos";

    public static void savePreferenceBoolean(Context c, boolean b, String key){
        SharedPreferences preferences = c.getSharedPreferences(STRING_PREFERENCES_REND,c.MODE_PRIVATE);
